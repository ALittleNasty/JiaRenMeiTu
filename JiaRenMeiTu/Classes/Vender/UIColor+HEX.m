...
+ (UIColor *)randomColor
{
    ...
    return [UIColor colorWithWholeRed:r green:g blue:b];
}

+ (UIColor *)mt_purpleColor
{
    return [UIColor colorWithHexString:@"#f141f4"];
}

+ (UIColor *)mt_blueColor
{
    return [UIColor colorWithHexString:@"#b184f4"];
}

+ (UIColor *)mt_redColor
{
    return [UIColor colorWithHexString:@"#d82067"];
}

+ (UIColor *)mt_orangeColor
{
    return [UIColor colorWithHexString:@"#f4ad84"];
}

+ (UIColor *)mt_yellowColor
{
    return [UIColor colorWithHexString:@"#e6ef34"];
}
//
+ (UIColor *)mt_greenColor
{
    return [UIColor colorWithHexString:@"#23b1ce"];
}
